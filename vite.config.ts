    ...
    test: {
      ...
      coverage: {
        ...
        include: [
          ...
          'src/features/client/pages/CreateRequestPage.tsx',
          'src/features/client/pages/ClientRequestsPage.tsx',
          'src/features/notifications/NotificationCenter.tsx',
          'src/features/notifications/labels.ts',
          'src/features/onboarding/OnboardingRequiredPage.tsx',
          'src/features/service-requests/status.ts',
          'src/features/shared/components/RoleWorkspace.tsx',
          'src/features/technician/pages/AssignedServicesPage.tsx',
          'src/features/technician/pages/AvailableRequestsPage.tsx',
          'src/features/technician/pages/TechnicianWalletPage.tsx',
          'src/features/verification/components.tsx',
          'src/routes/paths.ts',
        ],
        thresholds: {
          lines: 80,
